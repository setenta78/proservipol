    ...
    <div class="flex">
        ...
        <div class="ml-64 w-full mt-20 p-5">
			...
			<div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-6">
				<!-- Gestión de Usuarios -->
				<a href="app/gestor-usuarios/gestor_usuarios.php" class="block h-full">
					<div class="bg-white rounded-lg shadow-md p-6 text-center hover:shadow-lg transition-shadow duration-300 border border-green-200 h-full">
						<div class="text-green-600 mb-4">
							<i class="fas fa-users fa-3x"></i>
						</div>
						<h4 class="font-semibold text-lg text-gray-800">Gestor de Usuarios</h4>
						<p class="text-sm text-gray-600 mt-2">
							Administrar altas, bajas y perfiles de usuarios en PROSERVIPOL
						</p>
					</div>
				</a>

				<!-- Buscar Ingresos -->
				<a href="app/buscar-ingresos/buscar_ingresos_usuario.php" class="block h-full">
					<div class="bg-white rounded-lg shadow-md p-6 text-center hover:shadow-lg transition-shadow duration-300 border border-green-200 h-full">
						<div class="text-green-600 mb-4">
						...
						<p class="text-sm text-gray-600 mt-2">
							Consultar historial de ingresos al sistema con filtros por fecha, unidad y funcionario
						</p>
					</div>
				</a>

				<!-- Cámaras SAP -->
				<a href="app/camaras-corporales/camaras.php" class="block h-full">
					<div class="bg-white rounded-lg shadow-md p-6 text-center hover:shadow-lg transition-shadow duration-300 border border-green-200 h-full">
						<div class="text-green-600 mb-4">
						...
						<p class="text-sm text-gray-600 mt-2">
							Gestión de cámaras corporales y carga de datos desde SAP
						</p>
					</div>
				</a>
			</div>
