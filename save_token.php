...
$sql = "SELECT US_ACTIVO, TUS_CODIGO FROM USUARIO WHERE FUN_CODIGO = '$codigo_funcionario_safe'";
...
if (!in_array($tus_codigo, array(90, 310))) {
    ...
    responderJSON(array('success' => false, 'message' => 'No tiene permisos para acceder a este sistema. Solo perfiles Mesa de Ayuda (90) y Administrador (310).'), 403);
}
