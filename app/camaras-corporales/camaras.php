...
/**
 * Este archivo se sirve bajo el VirtualHost:
 *   aplicativos.des-proservipol.carabineros.cl
 * cuyo DocumentRoot es:
 *   /systema/web/aplicativos-proservipol
 *
 * Usamos DOCUMENT_ROOT como raíz del sistema para todos los includes.
 */
$rootPath = rtrim($_SERVER['DOCUMENT_ROOT'], '/') . '/';

// Includes desde la raíz del sistema
...
<head>
    ...
    <!-- Desde app/camaras-corporales/ subimos dos niveles hasta / -->
        ...
        <div class="ml-64 w-full mt-20 p-5">
            ...
            <div class="flex justify-center mb-4">
                ...
                <div class="w-full max-w-md">
                    <form action="../../queries/recibe_csv_validando.php" method="POST"
                        ...
                        <div class="file-input text-center mb-4">
                            ...
                            <label for="file-input"
                                   class="cursor-pointer inline-flex items-center justify-center space-x-2 p-2 text-white bg-green-700 hover:bg-green-800 rounded-md text-base">
            ...
            <div class="container mx-auto mt-20 p-5">
                ...
                <div class="flex justify-center mb-4">
                    <form action="" method="GET" class="w-full max-w-lg flex items-center">
                        <input type="text" name="search"
                               placeholder="Buscar por Marca, Modelo, Procedencia, etc."
                               class="w-full p-2 border rounded-l-lg focus:outline-none focus:ring focus:border-green-500"
                ...
                // Consulta SQL
                $sql = "SELECT VIDEOCAMARA.VC_CODIGO, VIDEOCAMARA.UNI_CODIGO, VIDEOCAMARA.VC_COD_ACTIVO_SAP,
                               VIDEOCAMARA.VC_COD_EQUIPO_SAP, VIDEOCAMARA.VC_NRO_SERIE,
                               MARCA_VIDEOCAMARA.MVC_DESCRIPCION, MODELO_VIDEOCAMARA.MODVC_DESCRIPCION,
                               PROCEDENCIA_RECURSO.PREC_DESCRIPCION, UNIDAD.UNI_DESCRIPCION
                        FROM VIDEOCAMARA
