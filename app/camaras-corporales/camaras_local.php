...
/**
 * Igual que camaras.php, usamos DOCUMENT_ROOT como raíz del sistema.
 */
        ...
        <div class="ml-64 w-full mt-20 p-5">
            ...
            <div class="flex justify-center mb-4">
                ...
                <div class="w-full max-w-md">
                    <form action="../../queries/recibe_csv_validando2.php" method="POST"
                        ...
                        <div class="file-input text-center mb-4">
                            ...
                            <label for="file-input"
                                   class="cursor-pointer inline-flex items-center justify-center space-x-2 p-2 text-white bg-green-700 hover:bg-green-800 rounded-md text-lg">
