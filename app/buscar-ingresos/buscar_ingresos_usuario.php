...
<body class="bg-gray-100 text-gray-700">
    ...
    <div class="flex">
        ...
        <div class="ml-64 w-full mt-20 p-5">
            ...
            <h3 class="text-center text-green-800 font-bold mt-5 text-xl">HISTORIAL DE INGRESOS AL SISTEMA PROSERVIPOL</h3>
            <hr class="my-2 border-gray-400">

            <!-- FORMULARIO DE FILTROS -->
            <div class="bg-white border rounded-lg p-4 mb-4 shadow-sm">
                <h4 class="text-base font-semibold text-green-700 mb-3">FILTROS DE BÚSQUEDA</h4>
                <div class="grid grid-cols-2 gap-4 mb-3">
                    ...
                    <div>
                        ...
                        <input type="date" id="fecha_desde"
                               class="w-full border rounded text-sm p-2 focus:outline-none focus:ring focus:border-green-500">
                    </div>
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-600 mb-1">Buscar Funcionario</label>
                ...
                <div class="flex gap-2 flex-wrap">
					...
					<button onclick="exportarExcel()"
							...
							class="bg-green-700 hover:bg-green-800 text-white font-semibold py-2 px-6 text-xs rounded hidden">
    ...
    <script src="/app/buscar-ingresos/js/buscar_ingresos.js"></script>
